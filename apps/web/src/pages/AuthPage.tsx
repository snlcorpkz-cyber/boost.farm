    ...
    <div className="h-full min-h-[100dvh] bg-gradient-to-b from-green-100 via-green-50 to-white flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 space-y-4">
          ...
          <button
            disabled
            className="w-full py-3 rounded-xl bg-white border-2 border-gray-200 text-gray-400 font-semibold text-sm flex items-center justify-center gap-2 cursor-not-allowed opacity-50"
          >
